...
static uint bmap(struct inode *ip, uint bn) {
  ...
  //printf("Trace: starting bmap() in fs.c\n");
  //printf("Trace:   bmap() return the disk block address of the nth block in inode ip. If there is no such block, bmap allocates one.\n");
  //printf("Trace:   bmap() arguments: ip (inode struct), uint bn (block number)\n");
...
int readi(struct inode *ip, char *dst, uint off, uint n) {
  ...
  //printf("Trace: starting readi() in fs.c\n");
  //printf("Trace:   readi() reads data from an inode.\n");
  //printf("Trace:   readi() arguments: ip (inode struct), dst (string pointer), n (uint offset)\n");
