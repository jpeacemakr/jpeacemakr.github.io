...
static int fd_to_file(int fd, struct file **pf) {
  ...
  //printf("Trace: starting fd_to_file() in tfsfile.c\n");
  //printf("Trace:   fd_to_file() takes a file descriptor and creates a struct file.\n");
  //printf("Trace:   fd_to_file() arguments: fd (file descriptor for file), file\n");
...
//creates a new file descriptor for a file
...
int tfs_read(int fd, void *p, int n) {
  //printf("Trace: starting tfs_read() in tfsfile.c\n");
  //printf("Trace:   tfs_read() reads from a buffer and loads it into a file.\n");
  //printf("Trace:   tfs_read() arguments: fd (file descriptor for file), p (buffer), n (length of buffer)\n");
...
//returns the metadata for a file descriptor
...
//PAGEBREAK!
//unlinks a file (like delete but not)
...
//creates a file given a path name
...
//opens a file using the path given
