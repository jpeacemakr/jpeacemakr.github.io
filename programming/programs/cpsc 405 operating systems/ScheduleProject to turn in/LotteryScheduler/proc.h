...
#define DEFAULT_TICKETS     10  // size of initial pages for proc
...
struct proc {
  ...
  ////////////////////////////////////////////////
  //added by me for lottery scheduler
  int tickets;        // as each process runs, it accumulates virtual runtime. the process with the least runs next
